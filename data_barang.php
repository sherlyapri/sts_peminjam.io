                            ...
                            <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo "<a href='edit.php?id=$data[id_barang]'><button class='btn btn-warning'>Edit</button></a> <a href='javascript:hapusData(".$data['id_barang'].")'><button class='btn btn-danger'>Hapus</button></a>"; ?></td>
                                        </tr>
                                        <?php
                                        $no++;
                                        endforeach; 
